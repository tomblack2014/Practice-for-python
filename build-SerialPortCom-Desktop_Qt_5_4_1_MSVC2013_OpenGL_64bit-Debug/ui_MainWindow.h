...
public:
    ...
    QPushButton *pushButton_Throwin;
    QPushButton *pushButton_Dropball;
    QMenuBar *menuBar;
    QMenu *menu;
    QMenu *menuOption;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_sideTag->setGeometry(QRect(10, 10, 91, 31));
        ...
        lineEdit_RefIP->setGeometry(QRect(10, 50, 91, 20));
        ...
        pushButton_Start->setGeometry(QRect(10, 120, 91, 41));
        pushButton_Throwin = new QPushButton(centralWidget);
        pushButton_Throwin->setObjectName(QStringLiteral("pushButton_Throwin"));
        pushButton_Throwin->setGeometry(QRect(10, 300, 91, 23));
        pushButton_Dropball = new QPushButton(centralWidget);
        pushButton_Dropball->setObjectName(QStringLiteral("pushButton_Dropball"));
        pushButton_Dropball->setGeometry(QRect(10, 330, 91, 23));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_Start->setText(QApplication::translate("MainWindow", "m_Start", 0));
        pushButton_Throwin->setText(QApplication::translate("MainWindow", "m_Throwin", 0));
        pushButton_Dropball->setText(QApplication::translate("MainWindow", "m_Dropball", 0));
